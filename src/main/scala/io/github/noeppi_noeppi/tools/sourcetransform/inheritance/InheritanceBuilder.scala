...
import io.github.noeppi_noeppi.tools.sourcetransform.util.cls.{ClassLocator, CompoundIndex, FakeIndex, TreeLocator}
import io.github.noeppi_noeppi.tools.sourcetransform.util.inheritance.{InheritanceExtractor, InheritanceIO, InheritanceMap}
